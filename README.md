...
This repo is a spike that I'm doing, to work on and learn ReactJS.

This is using the beginner Hello Work example from [ReactJS.org](https://reactjs.org/docs/hello-world.html).
